<template>
	<v-container class="align-center" style="max-width: 1200px;">
		<TileContainer :projects="featuredProject" v-if="featuredProject.length" width="826"
			@project-clicked="openDialog" />
		<TileContainer :projects="otherProjects" width="400" class="mt-12" @project-clicked="openDialog" />

		<ProjectDialog v-model="dialog" :currentProject="currentProject" @next="nextProject" @prev="prevProject" />
	</v-container>
</template>
